...
public class PlayerStats : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        HorizontalLayoutGroup panel = spellCanvas.GetComponentInChildren<HorizontalLayoutGroup>();
        enemiesAlive = 0;
        if (instance != null)
        {
        ...
        if (spells != null)
            foreach (GameObject spell in spells)
            {
                ...
                newButton.GetComponent<RectTransform>().sizeDelta = new Vector2(50, 50);
